                ...
                {[
                  ...
                  <div className="col-md-4 col-sm-6" key={index}>
                    <div className="single-how-works">
                      ...
                      <p>
                        Find the perfect room to rent, with spacious options and
                        affordable prices. Our listings provide you with a
                        variety of choices to meet your needs, ensuring comfort
                        and convenience.
                      </p>
                      <button
                    ...
                    <div className="single-explore-item">
                      <div className="single-explore-img">
                        ...
                        <div className="single-explore-img-info">
                          <button
                            onClick={() => (window.location.href = `${{ b1 }}`)}
                          >
                            best rated
                          </button>
                      ...
                      <div
                        className={`single-explore-txt bg-theme-${
                          (index % 5) + 1
                        }`}
                      >
                        <h2>
                        ...
                        <div className="explore-person">
                          <div className="row">
                            ...
                            <div className="col-sm-10">
                              <p>
                                Find the perfect room to rent, with spacious
                                options and affordable prices. Our listings
                                provide you with a variety of choices to meet
                                your needs, ensuring comfort and convenience...
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="col-md-4 col-sm-6">
                    <div className="single-blog-item">
                      ...
                      <div className="single-blog-item-txt">
                        ...
                        <h4>
                          posted <span>by</span> <a href="#">admin</a> march
                          2018
                        </h4>
                        <p>
                          Find the perfect room to rent, with spacious options
                          and affordable prices. Our listings provide you with a
                          variety of choices to meet your needs, ensuring
                  ...
                  <div className="col-md-4 col-sm-6">
                    <div className="single-blog-item">
                      ...
                      <div className="single-blog-item-txt">
                        <h2>
                          <a href="#">
                            How To Connect With My Friend Room Faster{" "}
                          </a>
                        </h2>
                        <h4>
                          posted <span>by</span> <a href="#">admin</a> march
                  ...
                  <div className="col-md-4 col-sm-6">
                    <div className="single-blog-item">
                      ...
                      <div className="single-blog-item-txt">
                        <h2>
                          <a href="#">
                            How to Looking For Your Perfect Room Faster
                          </a>
                        </h2>
                        <h4>
                          posted <span>by</span> <a href="#">admin</a> march
          ...
          <section id="contact" className="subscription">
            <div className="container">
              <div className="subscribe-title text-center">
                ...
                <p>
                  Listrace offers you the opportunity to list your business with
                  us, and we are fully equipped to promote your business.
                </p>
              </div>
              <div className="row">
